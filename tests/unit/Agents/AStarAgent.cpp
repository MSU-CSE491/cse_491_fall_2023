...
TEST_CASE("AStarAgent SelectAction", "[Agents]")
{
  ...
  // You should test if the selected action is correct based on the agent's current position and
  // goal For example, if the agent's position is (0, 0) and the goal is (10, 10), the action should
  // be "up" Ensure the action map is set correctly for this test
