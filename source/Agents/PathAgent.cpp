 ...
 */
cse491::GridPosition PathAgent::CalcNextPos() const { return offsets_[index_] + GetPosition(); }
 ...
 */
cse491::GridPosition PathAgent::GetNextPosition() { return UpdateAndGetNextPos(true); }
