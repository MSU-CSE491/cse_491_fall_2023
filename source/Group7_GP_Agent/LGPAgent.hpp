...
#define EXPERIMENTAL_CLASS                                                     \
  __attribute__((                                                              \
      annotate("experimental_class"),                                          \
      error(                                                                 \
          "This is an experimental class and is currently being worked on and should not be used in release")))
#define EXPERIMENTAL_FUNCTION                                                  \
  __attribute__((annotate("experimental_function"),                            \
                 error("This is an experimental function and is currently being worked on and should not be used in release")))
#endif
