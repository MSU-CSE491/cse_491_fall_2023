...
//    int start_x = 0, start_y = 0;
    ...
    world.AddAgent<netWorth::ClientInterface>(interface_name, "server_ip", ip_string, "server_port", port, "manager", &manager).SetProperty("symbol", '@').SetPosition(start_x, start_y);
